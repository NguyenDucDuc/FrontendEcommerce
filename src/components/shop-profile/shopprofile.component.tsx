                    ...
                    <div className="shop-profile-stats shop-profile-stats-left ">
                        <Row align="middle" >
                            ...
                            <Col span={17} style={{ marginTop: '20px' }}>
                                <h3>Hades Studio</h3>
                                <Button className="btn-color txt-btn-color" onClick={handleShowChatBox}>Chat ngay</Button>
                            </Col>
                        </Row>
                    </div>
                </Col>
                ...
                <Col span={15}>
                    <div className="shop-profile-stats shop-profile-stats-right">
                        <Row className="shop-stats">
                            <Col span={12}>
                                <h4>Sản phẩm: <span className="txt-red">150</span></h4>
                                <h4>Đang theo dõi: <span className="txt-red">2</span></h4>
                                <h4>Ngày tham gia: <span className="txt-red">23-09-2022</span></h4>
                            </Col>
                            <Col span={12}>
                ...
                showChatBox === true ?
                    <div className="message" style={{ zIndex: 10 }}>
                        <Row className="mgt-10">
                            ...
                            <Col span={2}>
                                <CloseOutlined style={{ color: 'red', fontWeight: 'bold' }} className="cs-pointer" onClick={handleHideChatBox} />
                            </Col>
                        </Row>
                        ...
                        <Row className="message-input">
                            ...
                            <Col span={3}>
                                <Button className="btn-color" style={{ color: 'white' }} icon={<SendOutlined />}>Gửi</Button>
                            </Col>
                        </Row>
                    </div>
                    : null
